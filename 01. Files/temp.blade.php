...
{{-- +++++++++++++++++++++++++ Product Details Page from https://codepen.io/haycuoilennao19/pen/bGVVKad +++++++++++++++++++++++++ --}}
<div style="margin-top:90px; " class="container">
    ...
    <div class="pd-wrap">
        <div class="container">
            <div class="heading-section text-center pb-4">
            ...
            {{-- <div class="product-info-tabs">
                ...
                </div> https://codepen.io/haycuoilennao19/pen/bGVVKad?editors=1010 --}}
    ...
    navText: [
    '<svg width="18px" height="18px" viewBox="0 0 11 20">
        <path style="fill:none;stroke-width: 1px;stroke: #000;" d="M9.554,1.001l-8.607,8.607l8.607,8.606" />
    </svg>',
    '<svg width="25px" height="25px" viewBox="0 0 11 20" version="1.1">
    ...
    if (current < 0) { current=count; } if (current> count) {
        ...
        if (current < start) { thumb.data("owl.carousel").to(current - onscreen, 100, true); } } function
            syncPosition2(el) { if (syncedSecondary) { var number=el.item.index; slider.data("owl.carousel").to(number,
            100, true); } } thumb.on("click", ".owl-item" , function (e) { e.preventDefault(); var
            number=$(this).index(); slider.data("owl.carousel").to(number, 300, true); }); // $(".qtyminus").on("click",
            function () { // var now=$(".qty").val(); // if ($.isNumeric(now)) { // if (parseInt(now) - 1> 0) {
            // now--;
            // }
            // $(".qty").val(now);
            // }
