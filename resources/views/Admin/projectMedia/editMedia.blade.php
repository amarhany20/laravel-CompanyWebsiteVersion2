...
@section('content')
    <div class="container mt-3">
        ...
        <form method="POST" action="{{ url('admin/projects/update/' . $project->id) }} "enctype='multipart/form-data'>
            @csrf
            @method('PUT')

            <div class="mb-3">
                <label for="projectTitle" class="form-label">Title*</label>
                <input required name="title" placeholder="Enter the Title" type="text"
                    value="{{ old('title', $project->title) }}" class="form-control" id="projectTitle">
            ...
            <div class="mb-3">
                ...
                <input required name="subtitle" placeholder="Enter Subtitle" type="text"
                    value="{{ old('subtitle', $project->subtitle) }}" class="form-control" id="projectSubtitle">
                <div id="projectLang3TitleHelp" class="form-text"></div>
                @error('subtitle')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            ...
            <div class="mb-3">
                ...
                <input name="lang2_Subtitle" placeholder="Enter Language 2 Subtitle" type="text"
                    value="{{ old('lang2_Subtitle', $project->lang2_Subtitle) }}" class="form-control"
                    id="projectLang2Subtitle">
            ...
            <div class="mb-3">
                ...
                <input name="lang3_Subtitle" placeholder="Enter Language 3 Subtitle" type="text"
                    value="{{ old('lang3_Subtitle', $project->lang3_Subtitle) }}" class="form-control"
                    id="projectLang3Subtitle">
            ...
            <div class="mb-3">
                ...
                <select id="categorySelect" class="form-control" name="category_id">
                    ...
                    @foreach ($categories as $category)
                        <option {{ old('category_id', $project->category->id) == $category->id ? 'selected' : '' }}
                            value="{{ $category->id }}">
            ...
            <div class="mb-3">
                ...
                <input required name="date" placeholder="Enter Date" type="date"
                    value="{{ old('date', $project->date) }}" class="form-control" id="Projectdate">
            ...
            <div class="mb-3">
                ...
                <input name="thumbnail_Alt" placeholder="Enter Thumbnail Alt" type="text"
                    value="{{ old('thumbnail_Alt', $project->thumbnail_Alt) }}" class="form-control"
                    id="ProjectThumbnailAlt">
            ...
            <div class="mb-3">
                ...
                <input name="lang2_Thumbnail_Alt" placeholder="Enter language 2 Thumbnail Alt" type="text"
                    value="{{ old('lang2_Thumbnail_Alt', $project->lang2_Thumbnail_Alt) }}" class="form-control"
                    id="ProjectLang2ThumbnailAlt">
            ...
            <div class="mb-3">
                ...
                <input name="lang3_Thumbnail_Alt" placeholder="Enter language 3 Thumbnail Alt" type="text"
                    value="{{ old('lang3_Thumbnail_Alt', $project->lang3_Thumbnail_Alt) }}" class="form-control"
                    id="ProjectLang3ThumbnailAlt">
            ...
            <div class="mb-3">
                ...
                <input name="meta_Title" placeholder="Enter Meta Title" type="text"
                    value="{{ old('meta_Title', $project->meta_Title) }}" class="form-control" id="ProjectMetaTitle">
            ...
            <div class="mb-3">
                ...
                <input name="lang2_Meta_Title" placeholder="Enter Language 2 Meta Title" type="text"
                    value="{{ old('lang2_Meta_Title', $project->lang2_Meta_Title) }}" class="form-control"
                    id="ProjectLang2MetaTitle">
            ...
            <div class="mb-3">
                ...
                <input name="lang3_Meta_Title" placeholder="Enter Language 3 Meta Title" type="text"
                    value="{{ old('lang3_Meta_Title', $project->lang3_Meta_Title) }}" class="form-control"
                    id="ProjectLang3MetaTitle">
            ...
            <div class="mb-3">
                ...
                <input name="meta_Description" placeholder="Enter Meta Description" type="text"
                    value="{{ old('meta_Description', $project->meta_Description) }}" class="form-control"
            ...
            <div class="mb-3">
                ...
                <input name="lang2_Meta_Description" placeholder="Enter Language 2 Meta Description" type="text"
                    value="{{ old('lang2_Meta_Description', $project->lang2_Meta_Description) }}" class="form-control"
            ...
            <div class="mb-3">
                ...
                <input name="lang3_Meta_Description" placeholder="Enter Language 3 Meta Description" type="text"
                    value="{{ old('lang3_Meta_Description', $project->lang3_Meta_Description) }}" class="form-control"
