<header>
    <nav id="navbar" style="backdrop-filter: blur(10px);" class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand text-bold" href="#">EDG Admin</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav py-1 me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('about') ? 'active' : '' }}"
                            href="{{ url('/project/all') }}">Projects Page</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('/contact') ? 'active' : '' }}" href="{{ url('/admin') }}">Main Menu</a>
                    </li>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class=" nav-link dropdown-toggle {{ request()->is('project/all') ? 'active' : '' }}"
                            href="/project/all" id="navbarUserDropdownMenuLink" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            User
                        </a>
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarUserDropdownMenuLink">
